...
import { OrderCourierCanceledEvent } from '@/domain/core/deliveries-and-orders/enterprise/events/order-courier-canceled-event'

@Injectable()
export class OnOrderCourierCanceled implements EventHandler {
  constructor(
  ...
  setupSubscriptions(): void {
    DomainEvents.register(
      ...
      OrderCourierCanceledEvent.name,
    )
  }

  private async sendNewAnswerNotification({
    order,
  }: OrderCourierCanceledEvent) {
